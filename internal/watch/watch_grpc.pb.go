...
type WatchClient interface {
	Run(ctx context.Context, in *WatchRequest, opts ...grpc.CallOption) (*WatchResponse, error)
}
...
func (c *watchClient) Run(ctx context.Context, in *WatchRequest, opts ...grpc.CallOption) (*WatchResponse, error) {
	out := new(WatchResponse)
	err := c.cc.Invoke(ctx, "/main.Watch/Run", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type WatchServer interface {
	Run(context.Context, *WatchRequest) (*WatchResponse, error)
...
func (UnimplementedWatchServer) Run(context.Context, *WatchRequest) (*WatchResponse, error) {
...
func _Watch_Run_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(WatchRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(WatchServer).Run(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/main.Watch/Run",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WatchServer).Run(ctx, req.(*WatchRequest))
	}
...
var Watch_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "main.Watch",
	HandlerType: (*WatchServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "Run",
			Handler:    _Watch_Run_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "internal/watch/watch.proto",
}
